...
meta_title: "Paskibra MTs Darul Huda Pusat"
description: "Membentuk kader pemimpin bangsa yang disiplin, tangguh, dan berkarakter Pancasila melalui pendidikan kepaskibrakaan di MTs Darul Huda Pusat."
draft: false
---
...
Pasukan Pengibar Bendera (Paskibra) MTs Darul Huda Pusat bukan sekadar kegiatan ekstrakurikuler baris-berbaris. Ini adalah **kawah candradimuka** bagi siswa-siswi terpilih untuk ditempa menjadi pribadi yang memiliki karakter baja, mental juara, dan jiwa nasionalisme yang tinggi.

Sebagai salah satu ekstrakurikuler paling prestisius, Paskibra MTs Darul Huda Pusat (biasa dijuluki _Satria Pandeglang_) berkomitmen mencetak kader pemimpin yang siap tampil prima dalam tugas negara maupun kehidupan sehari-hari.
...
Bergabung dengan Paskibra MTs Darul Huda Pusat memberikan nilai tambah yang signifikan bagi siswa:
...
Paskibra MTs Darul Huda Pusat telah mengukir berbagai tinta emas, di antaranya:
